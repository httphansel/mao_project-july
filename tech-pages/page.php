        ...
        <div class="row h-100">
                ...
                <div class="position-sticky pt-2">
                    ...
                    <ul class="nav flex-column text-center">
                        ...
                        $pages = [
                            ...
                            'farmer' => ['Farmers', 'fa-house-chimney-user'],
                            'resident' => ['Residents', 'fa-users'],
                            'livestock' => ['Livestock', 'fa-feather']
                        ];
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 p-3 h-100 overflow-auto bg-light">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <?php
                    $adminId = $_SESSION['tech_id'];
                    $adminQuery = "SELECT * FROM mao_technician WHERE  tech_id = '$adminId' ";
                ...
                <div class="collapse text-end ms-auto" id="optionsCollapse" style="width: 200px; align-self: flex-end;">
                    <div class="card card-body">
                        <ul class="nav text-end">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row g-2">
                                                <h2 class="text-center">Technician Profile</h2>
                                                ...
                                                <div class="col-4">
                                                    <div class="shadow shadow-lg p-2 text-center bg-success-subtle">
                                                        ...
                                                        <h5 class="my-2">TECH: <?= $admin['user_name'] ?></h5>
                                                ...
                                                <div class="col">
                                                    <div class="shadow shadow-lg p-2 bg-success-subtle">
                                                        <h3 class="text-center">Technician Information</h3>
                                                        <div class="border-bottom my-2"></div>
                                                        <div class="row mb-2 g-1">
                                                            <div class="col w-100">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control w-100" id="name" name="off_fname" placeholder="name@example.com" value="<?= $admin['tech_fname'] ?>" autocomplete="off" required>
                                                            ...
                                                            <div class="col w-100">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control w-100" id="name" name="off_mname" placeholder="name@example.com" value="<?= $admin['tech_mname'] ?>" autocomplete="off" required>
                                                            ...
                                                            <div class="col w-100">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control w-100" id="name" name="off_lname" placeholder="name@example.com" value="<?= $admin['tech_lname'] ?>" autocomplete="off" required>
                                                        ...
                                                        <div class="row mb-2 g-1">
                                                            <div class="col-3">
                                                                <div class="form-floating">
                                                                    <input type="number" class="form-control" id="floatingInputDisabled" value="<?= $admin['tech_extname'] ?>" placeholder="name@example.com" disabled>
                                                        ...
                                                        <div class="row g-1 mb-2">
                                                            ...
                                                            <div class="col mb-2">
                                                                ...
                                                                <button class="btn btn-success fw-bold mt-2" style="border-radius: 0; font-family: var(--kanit);" name="updateTechBtn">UPDATE</button>
                                                            </div>
                                                        </div>
                                                        </form>
                                                    </div>
                            ...
                            <li class="nav-item">
                                <a href="../pages/termscondition.php" target="_blank" class="nav-link text-success">
                                    Terms and Conditions
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="tech-function/logout.php?admin_id=<?= $admin['tech_id'] ?>" class="nav-link text-danger">
                                    Log Out
                                </a>
                            </li>
                        </ul>
